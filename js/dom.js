...
// --- RENDERING FUNCTIONS ---
// renderProjects() function is unchanged.
        ...
        listItem.innerHTML = `
            ...
            <div class="flex items-center pr-2">
                <button data-id="${project.id}" class="edit-project-btn p-1 text-slate-400 ${isActive ? 'text-white' : ''} hover:text-sky-400 opacity-0 group-hover:opacity-100 transition-opacity">
                    <svg xmlns="http://www.w.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="pointer-events: none;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.536L16.732 3.732z" /></svg>
                </button>
...
// ** UPDATED renderResources function **
...
// truncateURL and showNotification functions are unchanged
